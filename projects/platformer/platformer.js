$(function () {
  ...
  function setup() {
    ...
    createPlatform(300,620,100,25); //climb 1
    createPlatform(0, 700, 400, 50); //bottom platform
    createPlatform(400, 400, 50, 400); //spire 1
    createPlatform(200, 500, 100, 25); //climb 2
    createPlatform(600, 500, 100, 25); //bridge 1
